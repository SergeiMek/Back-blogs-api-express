...
export const emailManager = {
  async sendRegistrationEmail(email: string, confirmationCode: string) {
    ...
    const registrationMessage = `<h1>Thank you for registration!</h1><p>To finish registration process please follow the link below:<a href="https://some-front.com/confirm-registration?code=${confirmationCode}">complete registration</a></p>`; ///  https://somesite.com/confirm-email?code=
